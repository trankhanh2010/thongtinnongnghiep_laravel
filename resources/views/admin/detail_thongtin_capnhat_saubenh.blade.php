    ...
    @if (empty($detail0))
        @if (!empty($detail1))
            ...
            @if ($detail1[0]->chongchiutot != null)
                <br>
                <div>
                    <label class="form-label h4">Các loại sâu bệnh sâu bệnh chống chịu tốt: </label>
                    <textarea class="form-control" readonly  rows="5" id="thongtinkhac"
                        name="thongtinkhac" >{{ $detail1[0]->chongchiutot }}</textarea>
                </div>
            @endif
            @if ($detail1[0]->debinhiem != null)
                <br>
                <div>
                    <label class="form-label h4">Các loại sâu bệnh sâu bệnh dễ bị nhiễm: </label>
                    <textarea class="form-control" readonly  rows="5" id="thongtinkhac"
                        name="thongtinkhac" >{{ $detail1[0]->debinhiem }}</textarea>
                </div>
            @endif
        @endif
    @else
                    ...
                    <br>
                        ...
                        <div>
                            ...
                            <textarea class="form-control" readonly rows="5" id="thongtinkhac" name="thongtinkhac"
                                >{{ $detail0[0]->chongchiutot ?? '' }}</textarea>
                        </div>
            ...
            <div class="col">
                ...
                <div>
                    ...
                    <br>
                        <br>
                        <div>
                            <label class="form-label h4">Các loại lúa sâu bệnh khó gây hại: </label>
                            <textarea class="form-control" readonly rows="5" id="thongtinkhac" name="thongtinkhac"
                                >{{ $detail1[0]->chongchiutot ?? ''}}</textarea>
                        </div>
                    
                        <br>
                        <div>
                            <label class="form-label h4">Các loại lúa sâu bệnh dễ gây hại: </label>
                            <textarea class="form-control" readonly rows="5" id="thongtinkhac" name="thongtinkhac"
                                >{{ $detail1[0]->debinhiem ?? ''}}</textarea>
                        </div>
                @endif
                @if ($ds_hinhanh1 != null)
                    <div>
