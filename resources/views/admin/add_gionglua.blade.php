...
@section('content')
    <form id ="add" class="add" action="" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <textarea class="form-control" rows="1" id="comment" name="ten" placeholder="Nhập tên giống lúa">{{ old('ten') }}</textarea>
            @error('ten')
        ...
        <div>
            ...
            <textarea class="form-control" rows="10" id="dacdiem" name="dacdiem" placeholder="Nhập đặc điểm giống lúa">{{ old('dacdiem') }}</textarea>
            @error('dacdiem')
                <span style="color:red">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <textarea class="form-control" rows="10" id="thongtinkhac" name="thongtinkhac"
                placeholder="Nhập thông tin khác cho giống lúa">{{ old('thongtinkhac') }}</textarea>
            @error('thongtinkhac')
                <span style="color:red">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="row">
            <div class="col">
                <p class="form-label text-center h4">Giống lúa chống chịu tốt với:</p>
            ...
            <div class="col">
                <p class="form-label text-center h4">Giống lúa dễ bị nhiễm bởi:</p>
