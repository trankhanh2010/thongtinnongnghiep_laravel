    ...
    <div>
        <form id ="add" class="add" action="" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <textarea  class="form-control" rows="1" id="comment" name="ten" placeholder="Nhập tên giống lúa">{{ old('ten') ?? $detail->ten }}</textarea>
                @error('ten')
            ...
            <div>
                ...
                <textarea class="form-control" rows="10" id="dacdiem" name="dacdiem" placeholder="Nhập đặc điểm giống lúa">{{ old('dacdiem') ?? $detail->dacdiem }}</textarea>
                @error('dacdiem')
                    <span style="color:red">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea class="form-control" rows="10" id="thongtinkhac" name="thongtinkhac"
                    placeholder="Nhập thông tin khác cho giống lúa">{{ old('thongtinkhac') ?? $detail->thongtinkhac }}</textarea>
                @error('thongtinkhac')
                    <span style="color:red">{{ $message }}</span>
                @enderror
            </div>
                ...
                <div class="col">
                    @if ($ds_chongchiutot != null)
                        <div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="h4">Các loại sâu bệnh giống lúa chống chịu tốt: </p>
                                </div>
                ...
                <div class="col">
                    @if ($ds_debinhiem != null)
                        <div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="h4">Các loại sâu bệnh giống lúa dễ bị nhiễm: </p>
                                </div>
